...
; This testcase if for checking the continuous optimization.
; And also check the front argument to be remain.
; very similar to check3, but check3 is the case for infinite loop that I have trapped.
...
; CHECK-NEXT:    [[COND4:%.*]] = icmp eq i32 [[E]], [[F]]
